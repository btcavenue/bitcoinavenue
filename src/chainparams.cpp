...
public:
    CMainParams() {
        ...
        consensus.CSVHeight = 2; // 000000000000000004a1b34462cb8aeebd5799177f7a29cf28f2d1961716b5b5
        consensus.SegwitHeight = 2; // 0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893
        consensus.MinBIP9WarningHeight = 3; // segwit activation height + miner confirmation window
        ...
        vSeeds.emplace_back("seed.btcavenue.com");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,0);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x05, 0x89, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x05, 0x89, 0xAD, 0xE4};
...
public:
    CTestNetParams() {
        ...
        consensus.nSubsidyHalvingInterval = 210000;
        consensus.BIP16Exception = uint256S("0x000000000933ea01ad0ee984209779baaec3ced90fa3f408719526f8d77f4943");
        consensus.BIP34Height = 1;
        ...
        vSeeds.emplace_back("testnet-seed.btcavenue.com");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,111);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,196);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x05, 0x45, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x05, 0x45, 0x83, 0x94};
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,196);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x32, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x32, 0x83, 0x94};
